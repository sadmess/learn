...
namespace MySTL
{
    ...
    public:
        ...
        typedef value_type* iterator;//vector直接使用指针作为迭代器
    ...
    public:
        ...
        {
            copy_assign(il.begin(), il.end(), std::forward_iterator_tag{});
        }
        ...
        vector<T>::emplace(const_iterator pos, Args&& ...args)
    {
        ...
        {
            data_allocator::construct(MySTL::address_of(*end_), std::forward<Args>(args)...);
            ++end_;
        }
        else if (end_ != cap_)
        {
        ...
        reallocate_emplace(iterator pos, Args&& ...args)
    {
        ...
        try
        {
            ...
            data_allocator::construct(MySTL::address_of(*new_end), std::forward<Args>(args)...);
            ++new_end;
